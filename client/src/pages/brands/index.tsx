...
export default function BrandsPage() {
  ...
  const columns = [
    { header: 'Name', accessor: 'name' as keyof Brand },
    { header: 'Slug', accessor: 'slug' as keyof Brand },
    { header: 'Description', accessor: 'description' as keyof Brand },
    { 
      header: 'Status', 
      accessor: (row: Brand) => (
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage product brands</p>
        </div>
        <button
